...
<body class="brg">
  <div class="form-card">
    <img class="logo" src="images/murach_logo.jpg" alt="Murach Books" width="100" height="100">
    <h1>Thank You!</h1>
    <p>We’ve received your information successfully. Here’s what you submitted:</p>
    ...
    <p>
      <c:choose>
        ...
        <c:when test="${param.ref eq 'Other' and not empty param.otherText}">
          ${param.otherText}
        </c:when>
      </c:choose>
    </p>
